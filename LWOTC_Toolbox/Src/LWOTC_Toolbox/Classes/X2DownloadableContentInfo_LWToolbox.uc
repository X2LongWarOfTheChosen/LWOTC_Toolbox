...
{
	`TBTRACE("X2DLCInfo: Starting OnLoadedSavedGame",, 'LW_Toolbox');
...
{
	`TBTRACE("X2DLCInfo: InstallNewCampaign",, 'LW_Toolbox');
	class'XComGameState_LWToolboxOptions'.static.CreateModSettingsState_NewCampaign(class'XComGameState_LWToolboxOptions', StartState);
}
...
static function PatchupMissingPCSStats()
{
	...
	`TBTRACE("Updating Missing PCS Stats.");
